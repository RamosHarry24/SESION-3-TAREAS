...
//         //console.log(array[index].chartAt(0).toUpperCase() + array[index].slice(1))
//         cadenaCapitalizada.push((array[index].chartAt(0).toUpperCase() + array[index].slice(1)))
//     }    
...
//         if (objeto[index] === "") {
//             objeto[index] = prompt(`El campo ${index} está vacío`)
//         }
//     }
//     return objeto
// }
